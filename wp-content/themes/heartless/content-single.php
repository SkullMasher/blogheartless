	...
	<footer class="entry-footer">
		<?php
			...
			if ( ! heartless_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( 'This entry was tagged %2$s. Bookmark the <a href="%3$s" rel="bookmark">permalink</a>.', 'heartless' );
				} else {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( 'This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" rel="bookmark">permalink</a>.', 'heartless' );
				} else {
