...
function heartless_scripts() {
	...
	wp_enqueue_style( 'heartless-style-font-awesome', get_template_directory_uri() . '/fonts/font-awesome.min.css' ); // Include fonts
...
/**
 * Disable automatic scroll when clicked on read more
 */
